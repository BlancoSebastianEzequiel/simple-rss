  ...
  describe "DELETE #destroy" do
    ...
    context "when two feeds are in the same folder" do
      before(:each) do
        ...
        @folder_feed_1_user = FactoryBot.create(:folder_feed_user, feed: @feed_1, folder: @folder_1, user_id: @user.id)
        @folder_feed_1_user = FactoryBot.create(:folder_feed_user, feed: @feed_1, folder: @folder_2, user_id: @user.id)
        @folder_feed_2_user = FactoryBot.create(:folder_feed_user, feed: @feed_2, folder: @folder_1, user_id: @user.id)
        @folder_feed_2_user = FactoryBot.create(:folder_feed_user, feed: @feed_2, folder: @folder_2, user_id: @user.id)
      end
